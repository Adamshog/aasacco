        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:black;  max-width: auto; max-height: auto; white-space: nowrap;">AA SACO Management System</div>
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endspeed="300" 
                style="z-index: 6; font-size:40px; color:gray; font-weight:500; white-space: nowrap;">We care about your future </div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endelementdelay="0.1" 
                data-endspeed="300" 
                style="z-index: 7;  font-size:22px; color:gray; font-weight:500; max-width: auto; max-height: auto; white-space: nowrap;">Best Asociation Services you can trust</div>
            ...
            <div class="tp-caption lfb tp-resizeme scroll" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 8;"><a href="#." class="btn">Register Now</a> </div>
          </li>
